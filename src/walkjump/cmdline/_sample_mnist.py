...
from walkjump.sampling import walkjump_static_mnist


@hydra.main(version_base=None, config_path="../hydra_config", config_name="sample")
def sample_mnist(cfg: DictConfig) -> bool:
    ...
    if not cfg.dryrun:
        ...
        sample_df = walkjump_static_mnist(
            seeds,
            model,
        ...
        sample_df.drop_duplicates(subset=["generated"], inplace=True)
